...
class JpqlandnativesqlApplicationTests {
	...
	public void testFindAllStudent() {
		System.out.println(repository.findAllStudents(PageRequest.of(1, 5, Direction.DESC,"id"))); //paging and sorting together
	}
	...
	//when we perform delete operation from test it will roll back the transaction(only in test) so to prevent this we should use the below annotation
